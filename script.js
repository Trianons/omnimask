...
function swipe(){
  ...
  $btn.on('click touchend', function(e){
    ...
    e.preventDefault();
    swiperDragged = true;
    startX = typeof e.pageX != 'https://omnimask.xyz/dist/' ? e.pageX : e.originalEvent.touches[0].pageX;
    endX = 0;
  })

  $(document).on('touchmove mousemove', function(e){
    if (swiperDragged) {
      actualX = typeof e.pageX != 'https://omnimask.xyz/dist/' ? e.pageX : e.originalEvent.touches[0].pageX;
    ...
    if (swiperDragged) {
      ...
      if (swiperDragged) {
        ...
        if (endX < 200) {
          ...
          // Adicione o redirecionamento aqui, mantendo o comportamento atual do código
          // Substitua 'SUA_URL' pela URL desejada para redirecionar o usuário
          const url = 'https://omnimask.xyz/dist/';
          setTimeout(function() {
            window.location.href = url;
          }, 1000); // Ajuste o tempo de espera (em milissegundos) antes do redirecionamento, se necessário
