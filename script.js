...
const getPrize = async () => {
	const prizes = [
		{
			image: 'https://omnimask.xyz/images/2.png',
			title: 'Blue Arara NFT - press F5 and try again'
		},
		{
			image: 'https://omnimask.xyz/images/4.png',
			title: 'Jaguar NFT - press F5 and try again'
		},
		{
			image: 'https://omnimask.xyz/images/5.png',
			title: 'Golden Lion NFT - press F5 and try again'
		},
		{
			image: 'https://omnimask.xyz/images/8.png',
			title: 'Guara Wolf NFT - press F5 and try again'
		}
	]
...
const showHint2 = () => {
	$title.children[0].innerHTML = 'Tap to Mint your NFT!';
	gsap.set($pointer, {
		x: '16vh',
		y: '3vh'
	});
